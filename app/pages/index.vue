...
const title = 'Pomodoro таймер онлайн — 25 хвилин фокусу | Zaitsev.Pomodoro'
const description =
  'Безкоштовний Pomodoro таймер для роботи й навчання. 25 хвилин фокусу, перерви на 5 та 15 хвилин, пауза й керування з клавіатури.'
