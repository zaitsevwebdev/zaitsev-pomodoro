...
useSeoMeta({
  title: 'Про проєкт - Zaitsev.Pomodoro',
  description: 'Історія, технології та майбутнє незалежного вебпродукту Zaitsev.Pomodoro для сфокусованої роботи.'
})
    ...
    <div class="about-project__container">
      ...
      <div class="about-project__actions">
        <a
          ...
          href="https://zaitsevwebdevportfolio.vercel.app/"
          target="_blank"
        ...
        <a
          ...
          href="https://www.buymeacoffee.com/zaitsevwebdev"
          target="_blank"
          rel="noopener noreferrer"
        >
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" aria-hidden="true">
